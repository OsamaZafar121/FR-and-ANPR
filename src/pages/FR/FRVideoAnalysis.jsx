...
const FRVideoAnalysis = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-8">
            ...
            {isFilterOpen && (
              <div className="absolute left-0 mt-2 w-64 bg-white rounded-md shadow-lg border border-gray-200 z-20">
                <div className="p-4 space-y-3">
                  <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1">FR ID</label>
                    <input
                      type="text"
                      name="frId"
                      value={filters.frId}
        ...
        <div className="lg:w-[30%]">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <div className="flex justify-between items-center mb-2">
                <p className="text-gray-600">Unknown Faces</p>
      ...
      <div>
        <h2 className="text-xl font-semibold text-gray-700 mb-4">Detected Faces</h2>
...
export default FRVideoAnalysis;