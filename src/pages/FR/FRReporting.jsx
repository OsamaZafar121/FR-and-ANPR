...
function FRReporting() {
    ...
    datasets: [
      {
        ...
        backgroundColor: 'rgba(46, 204, 113, 0.7)', // Solid color for bars
        borderColor: '#2ecc71',
        borderWidth: 1,
        borderRadius: 4, // Rounded corners for bars
      },
      {
        label: 'UnDetected Faces',
        data: [2, 3, 1, 4, 2, 0, 0],
        backgroundColor: 'rgba(231, 76, 60, 0.7)', // Solid color for bars
        borderColor: '#e74c3c',
        borderWidth: 1,
        borderRadius: 4, // Rounded corners for bars
      },
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Face Recognition Over Time',
      },
      tooltip: {
        mode: 'index',
        intersect: false,
  ...
  return (
    <div className="max-w-6xl mx-auto p-5 bg-gray-50 rounded-lg">
      ...
      <div className="flex justify-between mb-6">
        ...
        <div className="bg-white p-4 rounded shadow-sm flex-1 mx-2">
          <h3 className="text-gray-700">Unknown Faces: 0</h3>
        </div>
      </div>
      ...
      <div className="bg-white p-5 rounded shadow-sm mb-6 h-[70vh] w-full">
        ...
        <div className="flex justify-center mb-6">
          <button className="bg-green-500 hover:bg-green-600 text-white py-3 px-6 rounded-lg text-lg font-medium shadow-md transition-all duration-300 transform hover:scale-105">
            Download Report <span className="ml-2">🌟</span>
          </button>
        </div>

      <div className="bg-white p-5 rounded shadow-sm">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Detected Faces</h2>
